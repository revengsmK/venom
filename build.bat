...
gcc -m32 -Wall -I "%~dp0res" "%~dp0src\main.c" "%~dp0src\venom.c" "%~dp0src\vnmfunc.c" "%~dp0res\rsrc.o" "%~dp0lib\ufmod.obj" -o "%~dp0venom.exe" -lwinmm -mwindows
...
cl /I "%~dp0res" "%~dp0src\main.c" "%~dp0src\venom.c" "%~dp0src\vnmfunc.c" "%~dp0res\rsrc.o" "%~dp0lib\ufmod.obj" /Fo:"%~dp0\" user32.lib gdi32.lib comdlg32.lib winmm.lib shell32.lib /link /out:"%~dp0venom.exe"
